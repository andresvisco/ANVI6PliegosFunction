    ...
    public class ProcesoPDF
    {
        ...
        private async Task<string> InsertarKeyPhrase(Pliego pliego, TraceWriter log)
        {
            try
            {
                ...
                System.Data.SqlClient.SqlConnection sqlConnection1 = new System.Data.SqlClient.SqlConnection("Server=tcp:techintpliegossqlserver.database.windows.net,1433;Initial Catalog=TECHINTPliegosSqlDB;;Persist Security Info=False;User ID=andres.visco;Password=2363Andy;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
